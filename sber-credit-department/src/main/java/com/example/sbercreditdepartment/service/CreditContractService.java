...
public class CreditContractService {
    ...
    public CreditContractService(CreditContractRepository creditContractRepository, RequestRepository requestRepository, CreditContractMapper creditContractMapper) {
    ...
    public void saveContract(CreditContractDTO dto) {
        ...
        dto.setMonthlyPayment((dto.getCurrentDebt() + 0.0) / dto.getDuration());
